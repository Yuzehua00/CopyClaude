...
from copy_claude.core.transport.socket_client import IpcError, SocketClient
...
class CopyClaudeTuiApp(App[None]):
    """CopyClaude TUI：终端滚屏风格，实时展示 agent 执行过程。"""
    ...
    _BANNER = (
        "[bold cyan]CopyClaude[/bold cyan]\n"
    ...
    async def _socket_loop(self) -> None:
        while True:
            ...
            try:
                ...
                self._update_header(f"subscribe error: {e}")
            finally:
